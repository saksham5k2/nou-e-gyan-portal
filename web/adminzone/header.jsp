<%-- 
    Document   : header
    Created on : Oct 14, 2023, 9:52:35 AM
    Author     : Rock
--%>
                  ...
                  <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                      <li class="nav-item dropdown">
                        <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="adminhome.jsp" style="color: white; font-size: 1.25rem;">Home</a>
                      </li>
                        
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="studentinfo.jsp" style="color: white; font-size: 1.25rem;">Student Management</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="enquirymgmt.jsp" style="color: white; font-size: 1.25rem;">Enquiry Management</a>
                      </li>
                 <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="feedbackmgmt.jsp" style="color: white; font-size: 1.25rem;">Feedback Management</a>
                      </li>
                     

                      <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="complainmgmt.jsp" style="color: white; font-size: 1.25rem;">Complain Management</a>
                      </li> 
                      
                      <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="uploadmaterial.jsp" style="color: white; font-size: 1.25rem;">Study Material</a>
                      </li>
                      
                      <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="changepassword.jsp" style="color: white; font-size: 1.25rem;">Change Password</a>
                      </li>
                      
                      <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="logout.jsp" style="color: white; font-size: 1.25rem;">Logout</a>
                      </li> 
