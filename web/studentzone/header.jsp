        ...
        <div class="col-sm-12">
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container-fluid">
                 ...
                 <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="postquestion.jsp" style="color: white; font-size: 1.25rem;">Discussion form</a>
                      </li>
                     

                      <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="response.jsp" style="color: white; font-size: 1.25rem;">Response</a>
                      </li> 
